...
const translations = {
  georgian: {
    ...
    professionalTrainingDesc: 'ცეკვას შეასწავლიან ანსამბლ ერისიონის ყოფილი მოცეკვავე, სერგო ზაქარიაძის უნივერსიტეტის, ქორეოგრაფიული მიმართულების კურსდამთავრებული, მედეა ჩახავას თეატრალური აკადემიის ქართული ქორეოგრაფიის თეორიის ლექტორი და ნსამბლ სამშობლოს დამფუძნებელი - <a href="https://www.facebook.com/levan.tsiklauri" target="_blank" rel="noopener noreferrer" class="text-amber-400 hover:text-amber-300 font-semibold underline transition-colors duration-300">ლევან წიკლაური</a>. შოთა რუსთაველის სახელობის თეატრისა და კინოს სახელმწიფო უნივერსიტეტის ქორეოგრაფიული მიმართულების ჯურსდამთავრებული და მოქმედი მოცეკვავე - <a href="https://www.facebook.com/sopho.omarashvili" target="_blank" rel="noopener noreferrer" class="text-amber-400 hover:text-amber-300 font-semibold underline transition-colors duration-300">სოფო ომარაშვილი</a>',
  ...
  english: {
    ...
    professionalTrainingDesc: 'Dance will be taught by <a href="https://www.facebook.com/levan.tsiklauri" target="_blank" rel="noopener noreferrer" class="text-amber-400 hover:text-amber-300 font-semibold underline transition-colors duration-300">Levan Tsiklauri</a>, former dancer of Ensemble Erisioni, graduate of Sergo Zakariadze University\'s choreographic direction, lecturer of Georgian choreography theory at Medea Chakhava Theater Academy, and founder of Ensemble Samshoblo. Also by <a href="https://www.facebook.com/sopho.omarashvili" target="_blank" rel="noopener noreferrer" class="text-amber-400 hover:text-amber-300 font-semibold underline transition-colors duration-300">Sopho Omarashvili</a>, graduate of Shota Rustaveli Theater and Film State University\'s choreographic direction and active dancer.',
