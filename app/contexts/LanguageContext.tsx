...
const translations = {
  georgian: {
    ...
    heroDescription: 'გამოიცადეთ ქართული ცეკვის მადლი, ვნება და კულტურული მემკვიდრეობა. შეუერთდით ჩვენს ანსამბლს და გახდით საუკუნეების ტრადიციის ნაწილი.',
    ...
    joinTitle: 'შეუერთდით ჩვენს ანსამბლს',
